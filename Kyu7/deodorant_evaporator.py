...
# Some people might prefer to reason with content, some other with percentages only. It's up to you but you must keep it as 
# a parameter because the tests have it as an argument.
...
print(evaporator(10,10,10)) #should return 22
