...
def movie(card, ticket, perc):
    n = 1 #Times gone to the movies
    total = 0
    percentages = ticket

    while True:
        percentages *= perc # Original ticket price times the percentage discount
        total += percentages #total cost of all discounted tickets

        systemA = ticket * n
        systemB = math.ceil(total + card)
...
print(movie(100, 10, 0.95)) #Should return 24
print(movie(500, 15, 0.9)) #Should return 43